    ...
    <section className="py-16 bg-gray-50">
      ...
      <div className="flex flex-wrap justify-center">
        {values.map((value, index) => (
          <div
            key={index}
            className="w-full sm:w-96  p-10 flex justify-center items-center flex-col text-center transform transition-all sm:hover:scale-105 sm:hover:shadow-2xl bg-white outline outline-2 outline-black"
          >
            {/* Icon và nội dung */}
            <div className="flex flex-row justify-center items-center">
              ...
              {/* Icon minh họa */}
              <div className="text-5xl text-blue-500 ml-3">
                {index === 0 ? (
                  <FaLeaf />
                ) : index === 1 ? (
                  <FaChartLine />
