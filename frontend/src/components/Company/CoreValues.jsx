        ...
        {values.map((value, index) => (
          ...
          >
            ...
            <div className="mb-6 text-4xl text-blue-600">
              {index === 0 ? <FaLeaf /> : index === 1 ? <FaChartLine /> : <FaHandshake />}
            </div>

            {/* Tiêu đề và mô tả */}
            <h3 className="text-2xl font-semibold text-blue-600 mb-4">{value.title}</h3>
            <p className="text-lg text-gray-700 mb-4">{value.description}</p>
